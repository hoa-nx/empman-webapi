...
namespace EmpMan.Common.Enums
{
    ...
    /// <para/>27 : Loại thông báo ví dụ như nhân sự / qui định oniste….
    /// <para/>28 : Nhóm chức vụ.
    /// <para/>29 : kết quả báo giá.
    /// <para/>30 : Loại nhân viên phỏng vấn
    /// </summary>
    public enum MasterKbnEnum
    {
