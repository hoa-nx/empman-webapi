...
[assembly: OwinStartup(typeof(EmpMan.Web.App_Start.Startup))]
...
namespace EmpMan.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(EmpManDbContext.Create);
        ...
        {
            var userStore = new UserStore<AppUser>(context.Get<EmpManDbContext>());
