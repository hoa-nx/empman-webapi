...
namespace EmpMan.Web.Controllers
{
    ...
    {
        private IMasterService _dataService;

        public MasterController(IErrorService errorService, IMasterService dataService) :
            base(errorService)
        {
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var listDataVm = Mapper.Map<List<MasterViewModel>>(listData);
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request, string keyword, int page, int pageSize = 20)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<List<Master>, List<MasterViewModel>>(query);

                var paginationSet = new PaginationSet<MasterViewModel>()
                {
                    Items = responseData,
                    PageIndex = page,
                    TotalRows = totalRow,
        ...
        public HttpResponseMessage GetById(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<Master, MasterViewModel>(model);
        ...
        public HttpResponseMessage Create(HttpRequestMessage request, MasterViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, MasterViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                else
                {
                    ...
                    dataFromDb.UpdateMaster(dataVm);
                    ...
                    var responseData = Mapper.Map<Master, MasterViewModel>(dataFromDb);
        ...
        public HttpResponseMessage Delete(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    var responseData = Mapper.Map<Master, MasterViewModel>(oldDataFromDb);
