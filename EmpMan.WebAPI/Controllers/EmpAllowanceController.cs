...
{
    [RoutePrefix("api/empallowance")]
    [Authorize]
    public class EmpAllowanceController : ApiControllerBase
    {
        private IEmpAllowanceService _dataService;

        public EmpAllowanceController(IErrorService errorService, IEmpAllowanceService dataService) :
            base(errorService)
        {
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var listDataVm = Mapper.Map<List<EmpAllowanceViewModel>>(listData);
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request, string keyword, int page, int pageSize = 20)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<List<EmpAllowance>, List<EmpAllowanceViewModel>>(query);

                var paginationSet = new PaginationSet<EmpAllowanceViewModel>()
                {
                    Items = responseData,
                    PageIndex = page,
                    TotalRows = totalRow,
        ...
        public HttpResponseMessage GetById(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<EmpAllowance, EmpAllowanceViewModel>(model);
        ...
        public HttpResponseMessage Create(HttpRequestMessage request, EmpAllowanceViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                {
                    EmpAllowance newData = new EmpAllowance();
                    ...
                    newData.UpdateEmpAllowance(dataVm);
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, EmpAllowanceViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                else
                {
                    ...
                    dataFromDb.UpdateEmpAllowance(dataVm);
                    ...
                    var responseData = Mapper.Map<EmpAllowance, EmpAllowanceViewModel>(dataFromDb);
        ...
        public HttpResponseMessage Delete(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    var responseData = Mapper.Map<EmpAllowance, EmpAllowanceViewModel>(oldDataFromDb);
