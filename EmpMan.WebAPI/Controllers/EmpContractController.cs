...
{
    [RoutePrefix("api/empcontract")]
    [Authorize]
    public class EmpContractController : ApiControllerBase
    {
        private IEmpContractService _dataService;

        public EmpContractController(IErrorService errorService, IEmpContractService dataService) :
            base(errorService)
        {
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var listDataVm = Mapper.Map<List<EmpContractViewModel>>(listData);
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request, string keyword, int page, int pageSize = 20)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<List<EmpContract>, List<EmpContractViewModel>>(query);

                var paginationSet = new PaginationSet<EmpContractViewModel>()
                {
                    Items = responseData,
                    PageIndex = page,
                    TotalRows = totalRow,
        ...
        public HttpResponseMessage GetById(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<EmpContract, EmpContractViewModel>(model);
        ...
        public HttpResponseMessage Create(HttpRequestMessage request, EmpContractViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                {
                    EmpContract newData = new EmpContract();
                    ...
                    newData.UpdateEmpContract(dataVm);
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, EmpContractViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                else
                {
                    ...
                    dataFromDb.UpdateEmpContract(dataVm);
                    ...
                    var responseData = Mapper.Map<EmpContract, EmpContractViewModel>(dataFromDb);
        ...
        public HttpResponseMessage Delete(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    var responseData = Mapper.Map<EmpContract, EmpContractViewModel>(oldDataFromDb);
