...
{
    [RoutePrefix("api/projectdetailresource")]
    [Authorize]
    public class ProjectDetailResourceController : ApiControllerBase
    {
        private IProjectDetailResourceService _dataService;

        public ProjectDetailResourceController(IErrorService errorService, IProjectDetailResourceService dataService) :
            base(errorService)
        {
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var listDataVm = Mapper.Map<List<ProjectDetailResourceViewModel>>(listData);
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request, string keyword, int page, int pageSize = 20)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<List<ProjectDetailResource>, List<ProjectDetailResourceViewModel>>(query);

                var paginationSet = new PaginationSet<ProjectDetailResourceViewModel>()
                {
                    Items = responseData,
                    PageIndex = page,
                    TotalRows = totalRow,
        ...
        public HttpResponseMessage GetById(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<ProjectDetailResource, ProjectDetailResourceViewModel>(model);
        ...
        public HttpResponseMessage Create(HttpRequestMessage request, ProjectDetailResourceViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                {
                    ProjectDetailResource newData = new ProjectDetailResource();
                    ...
                    newData.UpdateProjectDetailResource(dataVm);
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, ProjectDetailResourceViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                else
                {
                    ...
                    dataFromDb.UpdateProjectDetailResource(dataVm);
                    ...
                    var responseData = Mapper.Map<ProjectDetailResource, ProjectDetailResourceViewModel>(dataFromDb);
        ...
        public HttpResponseMessage Delete(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    var responseData = Mapper.Map<ProjectDetailResource, ProjectDetailResourceViewModel>(oldDataFromDb);
        ...
        {
            string fileName = string.Concat("Tai nguyen du an " + DateTime.Now.ToString("yyyyMMddhhmmsss") + ".xlsx");
