...
{
    [RoutePrefix("api/emponsite")]
    [Authorize]
    public class EmpOnsiteController : ApiControllerBase
    {
        private IEmpOnsiteService _dataService;

        public EmpOnsiteController(IErrorService errorService, IEmpOnsiteService dataService) :
            base(errorService)
        {
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var listDataVm = Mapper.Map<List<EmpOnsiteViewModel>>(listData);
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request, string keyword, int page, int pageSize = 20)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<List<EmpOnsite>, List<EmpOnsiteViewModel>>(query);

                var paginationSet = new PaginationSet<EmpOnsiteViewModel>()
                {
                    Items = responseData,
                    PageIndex = page,
                    TotalRows = totalRow,
        ...
        public HttpResponseMessage GetById(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<EmpOnsite, EmpOnsiteViewModel>(model);
        ...
        public HttpResponseMessage Create(HttpRequestMessage request, EmpOnsiteViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                {
                    EmpOnsite newData = new EmpOnsite();
                    ...
                    newData.UpdateEmpOnsite(dataVm);
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, EmpOnsiteViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                else
                {
                    ...
                    dataFromDb.UpdateEmpOnsite(dataVm);
                    ...
                    var responseData = Mapper.Map<EmpOnsite, EmpOnsiteViewModel>(dataFromDb);
        ...
        public HttpResponseMessage Delete(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    var responseData = Mapper.Map<EmpOnsite, EmpOnsiteViewModel>(oldDataFromDb);
