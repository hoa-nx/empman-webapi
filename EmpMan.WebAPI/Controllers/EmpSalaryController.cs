...
{
    [RoutePrefix("api/empsalary")]
    [Authorize]
    public class EmpSalaryController : ApiControllerBase
    {
        private IEmpSalaryService _dataService;

        public EmpSalaryController(IErrorService errorService, IEmpSalaryService dataService) :
            base(errorService)
        {
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var listDataVm = Mapper.Map<List<EmpSalaryViewModel>>(listData);
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request, string keyword, int page, int pageSize = 20)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<List<EmpSalary>, List<EmpSalaryViewModel>>(query);

                var paginationSet = new PaginationSet<EmpSalaryViewModel>()
                {
                    Items = responseData,
                    PageIndex = page,
                    TotalRows = totalRow,
        ...
        public HttpResponseMessage GetById(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<EmpSalary, EmpSalaryViewModel>(model);
        ...
        public HttpResponseMessage Create(HttpRequestMessage request, EmpSalaryViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                {
                    EmpSalary newData = new EmpSalary();
                    ...
                    newData.UpdateEmpSalary(dataVm);
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, EmpSalaryViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                else
                {
                    ...
                    dataFromDb.UpdateEmpSalary(dataVm);
                    ...
                    var responseData = Mapper.Map<EmpSalary, EmpSalaryViewModel>(dataFromDb);
        ...
        public HttpResponseMessage Delete(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    var responseData = Mapper.Map<EmpSalary, EmpSalaryViewModel>(oldDataFromDb);
