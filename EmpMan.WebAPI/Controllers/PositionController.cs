...
namespace EmpMan.Web.Controllers
{
    ...
    {
        private IPositionService _dataService;

        public PositionController(IErrorService errorService, IPositionService dataService) :
            base(errorService)
        {
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                //var listDataVm = Mapper.Map<List<PositionViewModel>>(listData);
                var listDataVm = listData.Adapt<List<PositionViewModel>>();
        ...
        public HttpResponseMessage GetAll(HttpRequestMessage request, string keyword, int page, int pageSize = 20)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                //var responseData = Mapper.Map<List<Position>, List<PositionViewModel>>(query);
                var responseData = query.Adapt<List<Position>, List<PositionViewModel>>();

                var paginationSet = new PaginationSet<PositionViewModel>()
                {
                    Items = responseData,
                    PageIndex = page,
                    TotalRows = totalRow,
        ...
        public HttpResponseMessage GetById(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                //var responseData = Mapper.Map<Position, PositionViewModel>(model);
                var responseData = model.Adapt<Position, PositionViewModel>();
        ...
        public HttpResponseMessage Create(HttpRequestMessage request, PositionViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, PositionViewModel dataVm)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                else
                {
                    ...
                    dataFromDb.UpdatePosition(dataVm);
                    ...
                    var responseData = Mapper.Map<Position, PositionViewModel>(dataFromDb);
        ...
        public HttpResponseMessage Delete(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    var responseData = Mapper.Map<Position, PositionViewModel>(oldDataFromDb);
