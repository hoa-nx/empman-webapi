...
namespace EmpMan.Service
{
    ...
    public interface IMasterService
    {
        ...
        /// </summary>
        /// <param name="master">Thông tin table đối tượng</param>
        ...
        /// </summary>
        /// <param name="master">Record đối tượng</param>
        ...
        /// <returns></returns>
        IEnumerable<Master> GetAll(string keyword);
        ...
        /// <returns></returns>
        IEnumerable<Master> GetAllPaging(string keyword, int page, int pageSize, out int totalRow);
        ...
        /// <returns></returns>
        IEnumerable<Master> Search(string keyword, int page, int pageSize, string sort, out int totalRow);
    ...
    public class MasterService : IMasterService
    {
        ...
        {
            return _masterRepository.Add(master);
        }
        ...
        /// <param name="id">Id đối tượng</param>
        /// <returns></returns>
        public Master DeleteLogic(int id)
        {
            var dataFromDb = _masterRepository.GetSingleById(id);

            dataFromDb.Status= true;
            _masterRepository.Update(dataFromDb);
            return dataFromDb;
        }
        ...
        /// <param name="keyword">Từ khóa tìm kiếm</param>
        /// <returns></returns>
        public IEnumerable<Master> GetAll(string keyword)
        {
            var query = _masterRepository.GetAll();
        ...
        /// <param name="totalRow">Tổng số record get được</param>
        /// <returns></returns>
        public IEnumerable<Master> GetAllPaging(string keyword, int page, int pageSize, out int totalRow)
        {
            return _masterRepository.GetMultiPaging(x => (x.Status && (x.Name.Contains(keyword) || x.ShortName.Contains(keyword))), out totalRow, page, pageSize);
        }
        ...
        /// <param name="totalRow">số dòng đối tượng get được</param>
        /// <returns></returns>
        public IEnumerable<Master> Search(string keyword, int page, int pageSize, string sort, out int totalRow)
        {
            var query = _masterRepository.GetMulti(x => x.Name.Contains(keyword));
        ...
        {
            return _masterRepository.GetSingleById(id);
        }
